...
ps5_event_t parseEvent(ps5_t prev, ps5_t cur)
{
  ...
  ps5Event.analog_move.stick.lx = cur.analog.stick.lx != prev.analog.stick.lx;
  ps5Event.analog_move.stick.ly = cur.analog.stick.ly != prev.analog.stick.ly;
  ps5Event.analog_move.stick.rx = cur.analog.stick.rx != prev.analog.stick.rx;
  ps5Event.analog_move.stick.ry = cur.analog.stick.ry != prev.analog.stick.ry;

  ps5Event.analog_move.button.r2 = cur.analog.button.r2 != prev.analog.button.r2;
  ps5Event.analog_move.button.l2 = cur.analog.button.l2 != prev.analog.button.l2;
